...
})(
  {
    ...
    '../../node_modules/core-js/modules/es6.array.filter.js': [
      function (require, module, exports) {
        ...
        $export(
          $export.P + $export.F * !require('./_strict-method')([].filter, true),
          'Array',
          {
    ...
    '../../node_modules/core-js/modules/es6.array.map.js': [
      function (require, module, exports) {
        ...
        $export(
          $export.P + $export.F * !require('./_strict-method')([].map, true),
          'Array',
          {
 ...
 */
    ...
    '../../node_modules/axios/lib/helpers/toFormData.js': [
      function (require, module, exports) {
        ...
        function isVisitable(thing) {
          return (
            _utils.default.isPlainObject(thing) || _utils.default.isArray(thing)
          );
        }
      ...
      function (require, module, exports) {
        ...
        exports.origin =
          ...
          exports.hasBrowserEnv =
            void 0;
        const hasBrowserEnv = (exports.hasBrowserEnv =
          typeof window !== 'undefined' && typeof document !== 'undefined');
        const _navigator = (exports.navigator =
         ...
         * @returns {boolean}
         */
        const hasStandardBrowserEnv = (exports.hasStandardBrowserEnv =
          hasBrowserEnv &&
          (!_navigator ||
        ...
        const defaults = {
          ...
          transformRequest: [
            function transformRequest(data, headers) {
              ...
              if (
                ...
                _utils.default.isReadableStream(data)
              ) {
                return data;
              }
          ...
          transformResponse: [
            function transformResponse(data) {
              ...
              if (
                _utils.default.isResponse(data) ||
                _utils.default.isReadableStream(data)
              ) {
                return data;
              }
        ...
        class AxiosHeaders {
          ...
          set(header, valueOrRewrite, rewrite) {
            ...
            if (
              ...
              _utils.default.isObject(header) &&
              _utils.default.isIterable(header)
            ) {
              let obj = {},
                dest,
                key;
    ...
    '../../node_modules/axios/lib/helpers/progressEventReducer.js': [
      function (require, module, exports) {
        ...
        exports.progressEventReducer =
          exports.progressEventDecorator =
          exports.asyncDecorator =
            void 0;
      ...
      function (require, module, exports) {
        ...
        var _default = (exports.default = _index.default.hasStandardBrowserEnv
          ? ((origin, isMSIE) => (url) => {
              ...
              new URL(_index.default.origin),
              _index.default.navigator &&
                /(msie|trident)/i.test(_index.default.navigator.userAgent),
            )
          : () => true);
      },
      {
          ...
          ? // Standard browser envs support document.cookie
            {
              write(name, value, expires, path, domain, secure) {
                ...
                _utils.default.isNumber(expires) &&
                  cookie.push('expires=' + new Date(expires).toGMTString());
                _utils.default.isString(path) && cookie.push('path=' + path);
                _utils.default.isString(domain) &&
    ...
    '../../node_modules/axios/lib/core/mergeConfig.js': [
      function (require, module, exports) {
        ...
        const headersToObject = (thing) =>
          thing instanceof _AxiosHeaders.default
            ? {
                ...thing,
              }
            : thing;
    ...
    '../../node_modules/axios/lib/helpers/resolveConfig.js': [
      function (require, module, exports) {
        ...
        var _default = (config) => {
          ...
          newConfig.url = (0, _buildURL.default)(
            (0, _buildFullPath.default)(
              newConfig.baseURL,
              newConfig.url,
          ...
          if (_utils.default.isFormData(data)) {
            if (
              _index.default.hasStandardBrowserEnv ||
              _index.default.hasStandardBrowserWebWorkerEnv
            ) {
          ...
          if (_index.default.hasStandardBrowserEnv) {
            withXSRFToken &&
              _utils.default.isFunction(withXSRFToken) &&
              (withXSRFToken = withXSRFToken(newConfig));
            if (
              withXSRFToken ||
              (withXSRFToken !== false &&
                (0, _isURLSameOrigin.default)(newConfig.url))
            ) {
              // Add xsrf header
              const xsrfValue =
                xsrfHeaderName &&
                xsrfCookieName &&
                _cookies.default.read(xsrfCookieName);
              if (xsrfValue) {
    ...
    '../../node_modules/axios/lib/adapters/xhr.js': [
      function (require, module, exports) {
        ...
        var _resolveConfig = _interopRequireDefault(
          require('../helpers/resolveConfig.js'),
        );
        function _interopRequireDefault(e) {
          return e && e.__esModule ? e : { default: e };
        }
          ...
          function (config) {
            return new Promise(function dispatchXhrRequest(resolve, reject) {
              ...
              request.onerror = function handleError(event) {
                ...
                const err = new _AxiosError.default(
                  msg,
              ...
              request.ontimeout = function handleTimeout() {
                let timeoutErrorMessage = _config.timeout
                  ...
                  : 'timeout exceeded';
                const transitional =
                  _config.transitional || _transitional.default;
              ...
              if (onDownloadProgress) {
                ...
                _progressEventReducer.progressEventReducer)(
                  onDownloadProgress,
                  true,
                );
              ...
              if (onUploadProgress && request.upload) {
                ...
                _progressEventReducer.progressEventReducer)(onUploadProgress);
          ...
          if (timeout || length) {
            ...
            const onabort = function (reason) {
              if (!aborted) {
                ...
                controller.abort(
                  err instanceof _AxiosError.default
                    ? err
                    : new _CanceledError.default(
    ...
    '../../node_modules/axios/lib/adapters/fetch.js': [
      function (require, module, exports) {
        ...
        var _composeSignals = _interopRequireDefault(
          require('../helpers/composeSignals.js'),
        );
        ...
        const { isFunction } = _utils.default;
        const globalFetchAPI = (({ Request, Response }) => ({
          Request,
          Response,
        }))(_utils.default.global);
        const { ReadableStream, TextEncoder } = _utils.default.global;
        const test = (fn, ...args) => {
          try {
            return !!fn(...args);
          } catch (e) {
        ...
        const factory = (env) => {
          ...
          const supportsResponseStream =
            isResponseSupported &&
            isReadableStreamSupported &&
            test(() => _utils.default.isReadableStream(new Response('').body));
          const resolvers = {
                  ...
                  !resolvers[type] &&
                    (resolvers[type] = (res, config) => {
                      ...
                      throw new _AxiosError.default(
                        ...
                        _AxiosError.default.ERR_NOT_SUPPORT,
                        config,
                      );
                    });
                },
          ...
          const getBodyLength = async (body) => {
            ...
            if (
              _utils.default.isArrayBufferView(body) ||
              _utils.default.isArrayBuffer(body)
            ) {
          ...
          const resolveBodyLength = async (headers, body) => {
            const length = _utils.default.toFiniteNumber(
          ...
          return async (config) => {
            ...
            responseType = responseType
              ...
              : 'text';
            let composedSignal = (0, _composeSignals.default)(
            ...
            try {
              if (
                ...
                if (
                  _utils.default.isFormData(data) &&
                ...
                if (_request.body) {
                  ...
                  _progressEventReducer.progressEventDecorator)(
                    requestContentLength,
                    (0, _progressEventReducer.progressEventReducer)(
                      (0, _progressEventReducer.asyncDecorator)(
                        onUploadProgress,
                      ),
                    ),
                  );
                  data = (0, _trackStream.trackStream)(
                    _request.body,
                    DEFAULT_CHUNK_SIZE,
                    onProgress,
                    flush,
              ...
              if (
                ...
                const responseContentLength = _utils.default.toFiniteNumber(
                  response.headers.get('content-length'),
                );
                const [onProgress, flush] =
                  (onDownloadProgress &&
                    (0, _progressEventReducer.progressEventDecorator)(
              ...
              let responseData = await resolvers[
                _utils.default.findKey(resolvers, responseType) || 'text'
              ](response, config);
    ...
    '../../node_modules/axios/lib/env/data.js': [
      function (require, module, exports) {
        ...
        const VERSION = (exports.VERSION = '1.12.2');
      },
      {},
    ],
    ...
    'alert.js': [
      function (require, module, exports) {
        ...
        var showAlert = (exports.showAlert = function showAlert(type, msg) {
          hideAlert();
          var markup = '<div class="alert alert--'
            .concat(type, '">')
            .concat(msg, '</div>');
          document
            .querySelector('body')
      ...
      function (require, module, exports) {
        ...
        var login = (exports.login = /*#__PURE__*/ (function () {
          var _ref = _asyncToGenerator(
            /*#__PURE__*/ _regenerator().m(function _callee(email, password) {
              var res, _t;
        ...
        var signup = (exports.signup = /*#__PURE__*/ (function () {
          var _ref3 = _asyncToGenerator(
            /*#__PURE__*/ _regenerator().m(function _callee3(userData) {
              var res, _err$response, _t3;
              return _regenerator().w(
                function (_context3) {
                  while (1)
                    switch ((_context3.p = _context3.n)) {
                      ...
                      case 1:
                        ...
                        if (res.data.status === 'success') {
                          (0, _alert.showAlert)(
                            'success',
                            'Account creted and Logged in successfully',
                          );
                          window.setTimeout(function () {
                            location.assign('/');
                          }, 1000);
                      ...
                      case 2:
                        ...
                        console.error(
                          'SIGNUP ERROR:',
                          _t3.response ? _t3.response.data : _t3,
                        );
                        (0, _alert.showAlert)(
                          'error',
                          ((_err$response = _t3.response) === null ||
                          _err$response === void 0 ||
                          (_err$response = _err$response.data) === null ||
                          _err$response === void 0
                            ? void 0
                            : _err$response.message) || 'Something went wrong!',
                        );
                      case 3:
