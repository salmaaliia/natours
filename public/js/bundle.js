...
var signup = exports.signup = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3(userData) {
    ...
    return _regenerator().w(function (_context3) {
      while (1) switch (_context3.p = _context3.n) {
        ...
        case 1:
          res = _context3.v;
          if (res.data.status === 'success') {
            (0, _alert.showAlert)('success', 'Account creted and Logged in successfully');
            window.setTimeout(function () {
              location.assign('/');
            }, 1000);
          }
        ...
        case 2:
          _context3.p = 2;
          _t3 = _context3.v;
          console.error('SIGNUP ERROR:', _t3.response ? _t3.response.data : _t3);
          (0, _alert.showAlert)('error', ((_err$response = _t3.response) === null || _err$response === void 0 || (_err$response = _err$response.data) === null || _err$response === void 0 ? void 0 : _err$response.message) || 'Something went wrong!');
        case 3:
    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        ...
        case 1:
          res = _context.v;
          if (res.data.status === 'success') {
            (0, _alert.showAlert)('success', "".concat(type.toUpperCase(), " updated successfuly!"));
            window.setTimeout(function () {
              location.reload();
            }, 1000);
          }
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"leaflet.js":[function(require,module,exports) {
"use strict";
  ...
  var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(tourId) {
    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        case 0:
          _context.p = 0;
          stripe = Stripe('pk_test_51SD1oQF1DoNyRJDYouTiud0MRbdWaQyfZeLseWrE3ZIxhkJqWIUZqW8ufzHMkZp0whkPWTsh1L31JV3MYayIGDYv00pPG5oz0p'); // 1) Get checkout session from API
          _context.n = 1;
          return (0, _axios.default)({
            method: 'GET',
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "13976" + '/');
